...
| name | Spaced Review |
| icon | school |
| description | Build a spaced repetition deck from Amplenote notes and review due cards. |
| instructions | Create a review deck note, write cards as Q/A blocks or Markdown tables, import cards from the current note or a tag, then review due cards with Again, Hard, Good, and Easy ratings. Source repository: https://github.com/i9496752-source/amplenote-spaced-review |

The first JavaScript code block below must contain the compiled plugin code.
...
## Bounty Evidence Links

- Source repository: https://github.com/i9496752-source/amplenote-spaced-review
- Usage video: `<USAGE_VIDEO_URL>`
- Code overview video: `<CODE_OVERVIEW_VIDEO_URL>`

Replace the two video placeholders before the final bounty claim.
